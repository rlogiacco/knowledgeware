...
@RestController
@RequestMapping("/api/knowledgeware-kafka")
public class KnowledgewareKafkaResource {

    private final Logger log = LoggerFactory.getLogger(KnowledgewareKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public KnowledgewareKafkaResource(KafkaProperties kafkaProperties) {
